...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // List of screens to navigate to (you'll need to create these)
  final List<Widget> _screens = [
    HomeContent(), // This will contain your current home content
    SearchScreen(), // You'll need to create this
    MovieListScreen(), // You'll need to create this
    MovieListScreen(), // You'll need to create this
  ];
  // SearchScreen
...
// // Placeholder for other screens - you'll need to implement these
