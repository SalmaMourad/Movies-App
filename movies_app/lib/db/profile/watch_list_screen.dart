...
class WatchListScreen extends StatelessWidget {
  ...
  final List<Map<String, String>> movies = [
    {"image": "Assets/Images/blackWidowPoster.jpg", "rating": "7.7"},
    {"image": "Assets/Images/IronManPoster.jpg", "rating": "9.4"},
    {"image": "Assets/Images/OnBoarding2.jpg", "rating": "9.0"},
            ...
            child: Padding(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return MovieCard(
                      movieImagePath: movies[index]["image"]!,
                      movieRating: movies[index]["rating"]!,
                      movieName: '');
